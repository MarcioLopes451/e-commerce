function HeroText() {
  return (
    <div className="w-full flex flex-col gap-4 sm:gap-8 px-4 pt-8 bg-[#F2F0F1] sm:p-28 sm:h-2/4 sm:w-3/5 sm:absolute sm:z-10 sm:left-30 sm:bg-transparent">
        <div className="md:h-4/5">
            <div className="font-inter text-4xl font-black sm:text-7xl">
                FIND CLOTHES <br /> THAT MATCHES <br /> YOUR STYLE
            </div>
        </div>

        <div className="text-[12px] text-[400]">
